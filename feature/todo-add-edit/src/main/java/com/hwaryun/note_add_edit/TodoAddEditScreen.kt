...
internal fun TodoAddEditRoute(
    ...
    TodoAddEditScreen(
        ...
        upsertTodo = viewModel::upsertTodo,
...
@Composable
private fun TodoAddEditScreen(
    state: TodoAddEditState,
    popBackStack: () -> Unit,
    upsertTodo: () -> Unit,
    deleteTodo: (Int) -> Unit,
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    if (state.isEdit) {
                        IconButton(onClick = { deleteTodo(state.todoId) }) {
                            Icon(
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = upsertTodo) {
